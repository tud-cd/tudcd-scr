...
\lstinputlisting[linerange=\%\ Start-\%\ End]{article.tex}

\begin{figure}[hb]
  \centering
  \setlength\fboxsep{0pt}
  \fbox{\includegraphics[width=\dimexpr(3\tudcdGridColumnwidth+2\tudcdGridColumnsep)]{article.pdf}}
...
\lstinputlisting[linerange=\%\ Start-\%\ End]{report.tex}
...
\begin{figure}[hb]
  ...
  \subcaptionbox{Erste Seite}{
    \fbox{\includegraphics[page=1,width=\dimexpr(2\tudcdGridColumnwidth+1\tudcdGridColumnsep)]{report.pdf}}
  }
  \subcaptionbox{Zweite Seite}{
    \fbox{\includegraphics[page=2,width=\dimexpr(2\tudcdGridColumnwidth+1\tudcdGridColumnsep)]{report.pdf}}
  }

  \subcaptionbox{Dritte Seite}{
    \fbox{\includegraphics[page=3,width=\dimexpr(2\tudcdGridColumnwidth+1\tudcdGridColumnsep)]{report.pdf}}
  }
  \caption{Resultat des der Beispieldatei}
\end{figure}
