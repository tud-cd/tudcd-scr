...
\chapter{Ich bin ein Titel}
\begin{multicols}{2}

Ein \enquote{x} hat die Höhe \getlengthnumber[sp]{1ex}\texttt{sp} es soll aber \getlengthnumber[sp]{1.7mm}\texttt{sp} sein.
\getlengthnumber[mm]{1ex}

Die Einstellungsgenauigkeit von \TeX{} beträgt \getlengthnumber[mm]{1sp}\unit{\mm}.
